...
import 'package:foodify/utils/signin_button/buttton_builder.dart';
...
class SignInButton extends StatelessWidget {
  ...
  SignInButton(
    ...
    this.shape,
    this.text,
    this.elevation = 2.0, this.height, this.width, 
  }) : assert(
            mini != true ||
