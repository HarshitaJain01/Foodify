...
class MyHomePage extends StatefulWidget {
  ...
  const MyHomePage({Key? key, required this.title, required this.breakfast, required this.lunch, required this.drinks, required this.burgers, required this.pizza, required this.cake, required this.rice}) : super(key: key);
...
header(String name, String title) {
  final isDarkMode = Theme.of(context).brightness == Brightness.light;
    return Row(
      ...
      children: [
        Text(name,
        style: isDarkMode? lightThemeData(context).textTheme.headline6 : darkThemeData(context).textTheme.headline6),
        IconButton(
            onPressed: () {
    ...
    return Scaffold(
        ...
        body: Container(
          ...
          decoration:BoxDecoration(
            color: isDarkMode? Colors.greenAccent.withAlpha(40) : Colors.white
          ),
          child: SafeArea(
            child: Column(
              ...
              children: <Widget>[
                Padding(
                      ...
                      [Row(
                        ...
                        children: 
                          [ 
                            ...
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(greetingMessage(),style: isDarkMode ? lightThemeData(context).textTheme.bodyText1 : darkThemeData(context).textTheme.bodyText1!.copyWith(color: Colors.black),),
                              SizedBox(height: 5,),
                              FutureBuilder(
                                future: _fetch(),
                                builder: (context, snapshot) {
                                  if (snapshot.connectionState == ConnectionState.done) {
                                    return Text("$fmyName$lmyName",
                                          style: isDarkMode ? lightThemeData(context).textTheme.headline4!.copyWith(color: Colors.black) : darkThemeData(context).textTheme.headline4!.copyWith(color: Colors.black),
                                    );
                                  }
                        ...
                        child: CircleAvatar(
                          backgroundImage: AssetImage(isDarkMode ? "assets/logo/foodify.png": "assets/logo/foodify.png",),
                          radius: 21,
                        ),
                              )
                        ],
                        ...
                        child: SizedBox(
                                ...
                                child: TextField(
                                            ...
                                            decoration: InputDecoration(
                                              fillColor: isDarkMode? Colors.white : Color(0xffF2F4F5),
                                              filled: true,
                                              hintText: "Search Recipes..",
                                              hintStyle: isDarkMode ? lightThemeData(context).textTheme.overline!.copyWith(fontSize: 13) : darkThemeData(context).textTheme.overline!.copyWith(color: Colors.black,fontSize: 13),
                 ...
                 Container(height: screenSize.height * 0,),
                 
                
                Expanded(child: Container(
                  decoration: BoxDecoration(
                      color: (isDarkMode ? lightThemeData(context).scaffoldBackgroundColor : darkThemeData(context).scaffoldBackgroundColor),
