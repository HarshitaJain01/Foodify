...
class _InputWrapperState extends State<InputWrapper> {
    ...
    return Column(
      children: <Widget>[
        ...
        Padding(
          ...
          child: IntlPhoneField(
            ...
            dropdownTextStyle: isDarkMode
                ? lightThemeData(context).textTheme.subtitle1
                : darkThemeData(context).textTheme.subtitle2,
            enabled: true,
            ...
            decoration: InputDecoration(
              ...
              onTap: wait
                  ...
                  : () async {
                      ...
                      authClass.verifyPhoneNumber(Phone!, context, setData);
                    },
              child: Padding(
                padding:
                ...
                child: (buttonName == "SEND" || buttonName == "RESEND")
                    ...
                    : Text(
                        "00:$start",
                        style: isDarkMode
                            ? lightThemeData(context).textTheme.subtitle2
                            : darkThemeData(context).textTheme.subtitle2,
                      ),
              ),
            )),
            style: isDarkMode
                ? lightThemeData(context).textTheme.subtitle1
                : darkThemeData(context).textTheme.subtitle1,
            countriesTextStyle: isDarkMode
                ? lightThemeData(context).textTheme.button
                : darkThemeData(context).textTheme.button,
        ...
        Text(
          ...
          style: isDarkMode
              ? lightThemeData(context).textTheme.overline
              : darkThemeData(context).textTheme.overline,
        ),
        SizedBox(
          height: 6,
        ),
  ...
  Widget otpField() {
    ...
    return OTPTextField(
      ...
      style: darkThemeData(context).textTheme.bodyText1!.copyWith(
          fontSize: 17, color: isDarkMode ? Colors.black : Colors.white),
