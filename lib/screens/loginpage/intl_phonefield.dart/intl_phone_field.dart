...
import 'package:foodify/screens/loginpage/intl_phonefield.dart/phone_number.dart';
...
class IntlPhoneField extends StatefulWidget {
  ...
  final TextStyle? countriesTextStyle;
  ...
  IntlPhoneField({
    ...
    this.flagsButtonPadding = const EdgeInsets.symmetric(vertical: 2),
    this.invalidNumberMessage, this.countriesTextStyle,
  });
              ...
              children: <Widget>[
                TextField(
                  decoration: InputDecoration(
                    ...
                    labelStyle: widget.dropdownTextStyle
                  ),
                  onChanged: (value) {
                      ...
                      children: <Widget>[
                        ListTile(
                          ...
                          title: Text(
                            ...
                            style: widget.countriesTextStyle,
                          ),
                          trailing: Text(
    ...
    return Padding(
      ...
      child: TextFormField(
        ...
        decoration: widget.decoration.copyWith(
          ...
          hintStyle: widget.dropdownTextStyle,
          errorStyle: TextStyle(color: isLightMode? Colors.redAccent : Colors.white),
          
          contentPadding: EdgeInsets.fromLTRB(13.0, 22.0, 5.0, 10.0),
